...
const launchConfig: LaunchConfig = {
  ...
  heroSlides: [
    ...
    {
      id: 'cowboy-running-hat',
      productName: 'Cowboy Running Hat',
      color: 'Black',
      collectionLabel: 'Values Performance Kit',
      backgroundWord: 'Values',
      image: 'https://ik.imagekit.io/edyl3oplm/Onemission/Products/cowboy-running-hat.svg?updatedAt=1785488941928',
      alt: 'Black cowboy running hat concept product',
    },
    {
      id: 'basic-legging-3/4',
      productName: 'Basic Legging 3/4',
      color: 'Black',
      collectionLabel: 'Purpose Built Essentials',
      backgroundWord: 'Purpose',
      image: 'https://ik.imagekit.io/edyl3oplm/Onemission/Products/3per4-legging.svg?updatedAt=1785488941923',
      alt: 'Black basic legging 3/4 concept product',
    },
    {
      id: 'basic-legging-long',
      productName: 'Basic Legging Long',
      color: 'Black',
      collectionLabel: 'Discipline In Motion',
      backgroundWord: 'Movement',
      image: 'https://ik.imagekit.io/edyl3oplm/Onemission/Products/basic-legging.svg?updatedAt=1785488941896',
      alt: 'Black basic legging long concept product',
    },
    {
      id: 'training-cap',
      productName: 'Corflex Sport Shirt',
      color: 'Black',
      collectionLabel: 'Purpose Built Essentials',
      backgroundWord: 'Purpose',
      image: 'https://ik.imagekit.io/edyl3oplm/Onemission/Products/ll.png?updatedAt=1785921030437',
      alt: 'Black training cap concept product',
    },
    {
      id: 'limited-fabric',
      productName: 'Awrah Fit',
      color: 'Black',
      collectionLabel: 'Values Performance Kit',
      backgroundWord: 'Values',
      image: 'https://ik.imagekit.io/edyl3oplm/Onemission/Products/SXZXXZXZZ.png?updatedAt=1785921030369',
      alt: 'Black premium fabric texture concept product',
    },
  ],
};
